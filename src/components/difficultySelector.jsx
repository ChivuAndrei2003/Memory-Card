export const DifficultySelector = ({ onSelect }) => {
  ...
  const levelStyles = {
    easy: "border-emerald-400 bg-emerald-500/10 text-black hover:bg-emerald-500/20 focus-visible:outline-emerald-300",
    medium:
      "border-amber-400 bg-amber-500/10 text-black hover:bg-amber-500/20 focus-visible:outline-amber-300",
    hard: "border-rose-400 bg-rose-500/10 text-black hover:bg-rose-500/20 focus-visible:outline-rose-300",
  };
